...
def _cmd_update_check(branch: str = "main", *, branch_explicit: bool = False):
    ...
    # even when ``hermes update`` would be a no-op. For non-fork installs,
    # preserve the upstream/main check on the default branch and compare
    # explicit non-default branches against origin/<branch>.
